...
export function LinkedInKnownScreen({ contact, user, onSignOut }: Props) {
  ...
  return (
    <div style={{ padding: '14px 16px 24px', background: 'white', minHeight: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      {/* Quick Actions Rail — LinkedIn only (no WhatsApp) */}
      <div style={{ ...CARD }}>
        <p style={SECTION_HEADING}>Log interaction</p>
        <div style={{ display: 'flex', gap: '8px', marginBottom: logTarget ? '10px' : '0' }}>
          {[
            { type: 'linkedin_msg', icon: <img src="/linkedin.jpg" alt="LinkedIn" style={{ width: '20px', height: '20px', objectFit: 'contain', borderRadius: '3px' }} />, label: 'LinkedIn' },
