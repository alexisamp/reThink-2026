...
export default function ListDetail() {
  ...
  const stages = useMemo<CrmViewStageSetting[]>(() => (list?.stages ?? []).map((stage, index) => ({
    id: stage.key,
    label: stage.label,
    color: stage.color || list?.color || ['#79D65E', '#2F6DF6', '#22B8CF', '#E8813A'][index % 4],
